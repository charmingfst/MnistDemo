...
//        requestReadExternalPermission();
        ...
        preTF =new RecognitionUtil(getAssets(),MODEL_FILE);//输入模型存放路径，并加载TensoFlow模型
    }
    ...
    private void recognition() {
        ...
        String outSoftmax = res;
        statusTextView.setText(res);
        Toast.makeText(this,"outSoftmax:"+ outSoftmax,Toast.LENGTH_LONG).show();
    }
